...
#df=pd.read_csv("C:/Users/shawr/Downloads/Devika Python Project/GOI.csv")
...
#Creating more 3 columns of per change in total,rural, urban
...
if Select_group=='Total':
    ...
    fig1.update_layout(barmode='group', title = 'Total Literacy Rate Across Nation :')
...
if Select_group=='Rural':
    ...
    fig2.update_layout(barmode='group', title = 'Literacy rate in rural areas acorss the country :')
...
if Select_group=='Urban':
    ...
    fig3.update_layout(barmode='group',title = "Literacy Rate in Urban areas across the country :")
...
Select_group= st.selectbox('Highest and Lowest Rate of',
                           options=['Total of 2001','Total of 2011','Rural of 2001' ,'Rural of 2011',
                                    'Urban of 2001','Urban of 2011']
                           )

if Select_group=='Total of 2001':
...
if Select_group=='Urban of 2001':
    lowest_2001 = df.sort_values(by=['Urban - 2001']).head()
    highest_2001 = df.sort_values(by=['Urban - 2001']).tail()
    fig = go.Figure(data = [
        go.Line(name = 'Lowest_2001', x=lowest_2001['States/ Union Territories'], y=lowest_2001['Urban - 2001'], mode='markers'),
        go.Line(name = 'Highest_2001', x=highest_2001['States/ Union Territories'], y=highest_2001['Urban - 2001'], mode='markers')
        ])

    fig.update_layout(barmode='group', title = 'Lowest and highest "Urban literacy" rate in 2001')
    st.plotly_chart(fig)
if Select_group=='Urban of 2011':
...
fig.update_layout(barmode='group',title="States and Union Territories")
st.plotly_chart(fig)
...
st.subheader("Bar Plot by Region")
